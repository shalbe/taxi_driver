...
import 'package:tigwaal_driver/functions/geohash.dart';
import 'package:tigwaal_driver/pages/chatPage/chat_page.dart';
import 'package:tigwaal_driver/pages/onTripPage/invoice.dart';
import 'package:tigwaal_driver/pages/loadingPage/loading.dart';
import 'package:tigwaal_driver/pages/login/login.dart';
import 'package:tigwaal_driver/pages/navDrawer/nav_drawer.dart';
import 'package:tigwaal_driver/pages/noInternet/nointernet.dart';
import 'package:tigwaal_driver/pages/vehicleInformations/docs_onprocess.dart';
                                                                  ...
                                                                  child: Column(
                                                                    children: [
                                                                      BlocProvider(
                                                                        ...
                                                                        child: BlocBuilder<
                                                                            PaymentCubit,
                                                                            PaymentState>(builder: (context, state) {
                                                                          PaymentCubit
                                                                              cubit =
                                                                              PaymentCubit.get(context);
                                                                          return cubit.getAdd != null
                                                                              ? Padding(
                                                                                  padding: EdgeInsets.only(bottom: 1, top: 30),
                                                                                  child: Container(
                                                                                    height: 70,
                                                                                    width: double.infinity,
                                                                                    child: cubit.getAdd!.data!.isNotEmpty
                                                                                        ? CarouselSlider(
                                                                                            items: cubit.getAdd!.data!
                                                                                                .map((e) => Container(
                                                                                                      height: 70,
                                                                                                      // width: 450.w,
                                                                                                      decoration: BoxDecoration(
                                                                                                          ...
                                                                                                          image: DecorationImage(fit: BoxFit.cover, image: NetworkImage('${e.image}'))),
                                                                                                    ))
                                                                                                .toList(),
